...
pub fn run() -> io::Result<()> {
    ...
    let mut domain_index = header("Index by Domain", None);
    ...
    let mut recent = header("Recently Modified", None);
...
fn header(title: &str, note: Option<&str>) -> String {
    let note = note.unwrap_or("Auto-generated by sentinel. Do not edit manually.");
    format!("# {title}\n\n*{note}*\n\n")
}
